...
const PUZZLE_DB = [
  ...
  {e:["🦍","🏙️","✈️"],a:"king kong",h1:"Giant gorilla film",h2:"Empire State Building",h3:"Beauty killed the beast",cat:"Movie",diff:"medium"},
  ...
  {e:["🌌","⚫","⌚"],a:"interstellar",h1:"Christopher Nolan space",h2:"Black hole exploration",h3:"Matthew McConaughey",cat:"Movie",diff:"medium"},
  ...
  {e:["🤼","🏋️","🥇"],a:"dangal",h1:"Wrestling biopic",h2:"Aamir Khan starrer",h3:"Phogat sisters story",cat:"Bollywood",diff:"easy"},
  {e:["🎓","👨‍🎓","😂"],a:"3 idiots",h1:"Engineering comedy",h2:"Aamir Khan Rancho",h3:"All Izz Well",cat:"Bollywood",diff:"easy"},
  {e:["🤰","🔍","🌆"],a:"kahaani",h1:"Mystery thriller",h2:"Vidya Balan Kolkata",h3:"Pregnant detective",cat:"Bollywood",diff:"medium"},
  ...
  {e:["🚂","🌾","❤️"],a:"dilwale dulhania le jayenge",h1:"DDLJ romance",h2:"Raj and Simran",h3:"Mustard fields Punjab",cat:"Bollywood",diff:"hard"},
  ...
  {e:["🔇","😄","🏔️"],a:"barfi",h1:"Deaf mute character",h2:"Ranbir Kapoor",h3:"Darjeeling setting",cat:"Bollywood",diff:"medium"},
  ...
  {e:["🏃","🥇","🇮🇳"],a:"bhaag milkha bhaag",h1:"Flying Sikh biopic",h2:"Farhan Akhtar",h3:"Milkha Singh story",cat:"Bollywood",diff:"medium"},
  ...
  {e:["👑","⚔️","💪"],a:"bahubali",h1:"Epic Telugu film",h2:"SS Rajamouli made it",h3:"Why Kattappa killed",cat:"Bollywood",diff:"easy"},
  ...
  {e:["🚘","🏭","🇮🇳"],a:"tata",h1:"Conglomerate group",h2:"Salt to software",h3:"Ratan Tata legacy",cat:"Indian Brand",diff:"easy"},
  {e:["🛵","📱","🏙️"],a:"ola",h1:"Ride sharing app",h2:"Book a cab scooter",h3:"Indian Uber rival",cat:"Indian Brand",diff:"easy"},
  ...
  {e:["🍔","🛵","🏃"],a:"swiggy",h1:"Food delivery app",h2:"Orange delivery bags",h3:"Instamart groceries",cat:"Indian Brand",diff:"easy"},
  {e:["📱","💰","🔷"],a:"paytm",h1:"Digital payments",h2:"One97 Communications",h3:"Scan QR and pay",cat:"Indian Brand",diff:"easy"},
  {e:["🍽️","🔴","📱"],a:"zomato",h1:"Food delivery platform",h2:"Red color branding",h3:"Restaurant discovery",cat:"Indian Brand",diff:"easy"},
  ...
  // ── INDIAN HISTORY ─────────────────────────────────────────────────────────
  {e:["🕊️","✊","🇮🇳"],a:"mahatma gandhi",h1:"Father of Nation",h2:"Non violence champion",h3:"Dandi March leader",cat:"Indian History",diff:"easy"},
  ...
  {e:["⚔️","✊","🇮🇳"],a:"subhas chandra bose",h1:"Netaji",h2:"INA commander",h3:"Azad Hind Fauj",cat:"Indian History",diff:"easy"},
  ...
  {e:["⛩️","⚔️","🌸"],a:"ghost of tsushima",h1:"Samurai open world game",h2:"Japan setting",h3:"Jin Sakai warrior",cat:"Games",diff:"hard"},
  {e:["🧝","⚔️","🌿"],a:"zelda",h1:"Nintendo adventure game",h2:"Link is the hero",h3:"Princess Zelda",cat:"Games",diff:"easy"},
  ...
  {e:["🥇","🎯","🇮🇳"],a:"neeraj chopra",h1:"Indian javelin thrower",h2:"Olympic gold 2021",h3:"Tokyo Olympics hero",cat:"Sports",diff:"medium"},
